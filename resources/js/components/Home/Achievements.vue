<template>
    <div class="py-10 xl:py-20" style="background:linear-gradient(131deg, rgb(232, 229, 254), rgb(216 226 255) 26.82% 96.89%);" >
      <div class="mx-10 mt-10 lg:mx-20 lg:mt-0 gap-4 xl:w-7xl xl:mx-auto">
        <div class="flex justify-center">
          <span class="text-4xl sm:text-6xl xl:text-6xl font-semibold mb-5 sm:mb-8 py-4 text-center max-w-sm md:max-w-lg lg:max-w-2xl xl:max-w-4xl mx-auto font-heading border-b-4 border-fun-blue-500">Achievements</span>
        </div>
        ...
        <div  ref="animateSection" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 justify-evenly">
          <div v-for="(item, index) in achievements" :key="index" class="rounded-lg shadow-xl hover:shadow-fun-blue-500/10 transition-all duration-200 bg-white px-20 py-10 text-center flex-1">
